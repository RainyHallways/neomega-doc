...
const defaultAuthor = "RainyHallways"
...
<template>
  ...
  <div v-else class="flex gap-2 items-center">
    <a
      ...
      target="_blank"
      class="flex items-center gap-2">
      <img src="https://cdn.crashmc.com/https://github.com/RainyHallways.png" class="w-8 h-8 rounded-full" />
      <p class="vp-main-clolr">{{ "RainyHallways" }}</p>
    </a>
  </div>
</template>
