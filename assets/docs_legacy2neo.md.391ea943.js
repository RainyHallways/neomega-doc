import{_ as s,c as n,o as a,Q as e}from"./chunks/framework.e77b359b.js";const u=JSON.parse('{"title":"从legacy-omega迁移至neomega","description":"","frontmatter":{},"headers":[],"relativePath":"docs/legacy2neo.md","filePath":"docs/legacy2neo.md","lastUpdated":1710856686000}'),l={name:"docs/legacy2neo.md"},p=e(`<h1 id="从legacy-omega迁移至neomega" tabindex="-1">从legacy-omega迁移至neomega <a class="header-anchor" href="#从legacy-omega迁移至neomega" aria-label="Permalink to &quot;从legacy-omega迁移至neomega&quot;">​</a></h1><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>此文档已经过时，其中的一些内容可能不适于现今版本的neomega!</p></div><h2 id="迁移使用" tabindex="-1">迁移使用 <a class="header-anchor" href="#迁移使用" aria-label="Permalink to &quot;迁移使用&quot;">​</a></h2><p>以下为 neomega 初次使用的配置流程 以commit(345):03a275e为例</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">╔═════════════════════════════════════════════════════════════════╗</span></span>
